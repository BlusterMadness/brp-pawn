...
CreateThread(function()
	...
	TaskStartScenarioInPlace(buyerPed, 'WORLD_HUMAN_AA_SMOKE', true)
...
RegisterNetEvent('brp-pawn:giveinput', function (data)
    ...
    if input[1] ~= nil then
        if input[2] ~= nil then
            TriggerServerEvent('brp-pawn:sellitem',data.item, data.price, input[1], input[2])
        else
